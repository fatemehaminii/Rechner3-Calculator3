...
Eintrag_1 = Entry(Fenster, width=30, font=('arial', 14, 'bold'),
                  bd=12, insertwidth=4, bg='powder blue', textvariable=derText_desEingangs)
Eintrag_1.grid(row=5, column=0, rowspan=2, columnspan=5)
...
# Taste sinh
button("sinh", 11, 3, command=lambda: btn_klick("sinh"))
